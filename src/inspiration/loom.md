...
![Game overview screenshot — Bobbin on mountaintop at start of game](./loom-overview.png)
...
![Sheep in field before and after being dyed green for camouflage](./loom-puzzle2.png)
...
|------|-------------------|--------------|
| Egg Opening Tutorial | Player learns OPEN draft by examining the swan egg, then immediately applies it to open the egg—introductory mechanics lesson | [Pattern Learning](../puzzles/pattern-learning.md) |
| Light in Darkness | Night-vision draft from gravestone trees is applied to dark tent interior to reveal spinning wheel | [Pattern Learning](../puzzles/pattern-learning.md) |
