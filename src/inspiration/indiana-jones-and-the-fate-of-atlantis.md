...
> Ask the parrot perched outside: "Title?"
> Parrot responds: "Hermocrates"
...
![Tikal temple interior — show animal head on left wall, tarnished spiral on right wall](./indiana-jones-and-the-fate-of-atlantis-puzzle1.png)
...
![Dark dig site chamber — player navigating blindly by mouse cursor; generator silhouette visible when lit](./indiana-jones-and-the-fate-of-atlantis-puzzle2.png)
...
![Cretan ruins showing bull mural and two hidden statue locations under rubble](./indiana-jones-and-the-fate-of-atlantis-puzzle3.png)
...
|------|-------------------|--------------|
| Barnett College Dialogue Retrieval | Randomized hiding location (chest, cat statue, bookcase) requires accessing different building areas [DarthMaul] | [Multi-Faceted Plan](../puzzles/multi-faceted-plan.md) |
