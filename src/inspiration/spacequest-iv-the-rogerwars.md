...
![Roger Wilco navigating the time pod interface across multiple Space Quest eras—each era has distinct graphics style](./spacequest-iv-overview.png)
...
![Time pod interface showing partial codes discovered—gum wrapper displays three symbols, hintbook reveals remaining three](./sq4-puzzle1.png)
...
![Laser tube section with invisible beams—Roger holds lit cigar as smoke reveals otherwise unseen deadly obstacles](./sq4-puzzle2.png)
...
![Supercomputer interface showing draggable icons—Roger must delete robots first, then brain, creating urgency through invisible countdown](./sq4-puzzle3.png)
