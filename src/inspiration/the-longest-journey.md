...
![Game overview screenshot — April Ryan standing between Stark and Arcadia](./the-longest-journey-overview.png)
...
![Police station locker room showing retinal scanner door and Minelli's unlocked stall](./the-longest-journey-puzzle1.png)
...
![Island view showing four speaking phones at different locations requiring line-of-sight alignment](./the-longest-journey-puzzle3.png)
...
| Fable Question Quiz | Collect four fables from NPCs (Seana, Neema, old alterter, Isam); answer guard's city entry trivia questions correctly | [Information Brokerage](../puzzles/information-brokerage.md) |
