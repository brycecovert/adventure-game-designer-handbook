...
![Driving range with flags positioned to guide crocodiles in walking path from Pro Shop to Dunk the Beast tank](./sam-max-puzzle1.png)
...
![Sam wearing assembled bigfoot costume made from various collected materials, standing before inn guard](./sam-max-puzzle2.png)
...
![VR simulation showing sword in stone with dragon emerging from cave entrance](./sam-max-puzzle3.png)
