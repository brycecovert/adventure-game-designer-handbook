...
![Airline terminal screen showing global destinations—representing the cross-continental travel mechanic](./zak-mckracken-overview.png)
...
![Massive Martian face door with button panel—the sequence interface requiring numbers learned in Zaire](./zak-mckracken-puzzle1.png)
...
![Stonehenge altar with four item slots—the assembly point requiring whiskey, flagpole, two crystals and scroll](./zak-mckracken-puzzle2.png)
